...
public class SensorRoleMapTests
{
    ...
    [InlineData(HardwareType.GpuNvidia, SensorType.Clock, "GPU Core", SensorRole.GpuCoreClock)]
    [InlineData(HardwareType.GpuAmd, SensorType.Clock, "GPU Core", SensorRole.GpuCoreClock)]
    [InlineData(HardwareType.GpuIntel, SensorType.Clock, "GPU Core", SensorRole.GpuCoreClock)]
    [InlineData(HardwareType.GpuNvidia, SensorType.Clock, "GPU Memory", SensorRole.GpuMemoryClock)]
    [InlineData(HardwareType.GpuAmd, SensorType.Clock, "GPU Memory", SensorRole.GpuMemoryClock)]
    [InlineData(HardwareType.GpuIntel, SensorType.Clock, "GPU Memory", SensorRole.GpuMemoryClock)]
    [InlineData(HardwareType.GpuAmd, SensorType.Load, "GPU Memory Controller", SensorRole.GpuLoadMemoryController)]
    [InlineData(HardwareType.GpuIntel, SensorType.Power, "GPU Power", SensorRole.GpuPower)]
    [InlineData(HardwareType.GpuNvidia, SensorType.SmallData, "GPU Memory Total", SensorRole.GpuVramTotal)]
    [InlineData(HardwareType.GpuNvidia, SensorType.SmallData, "GPU Memory Free", SensorRole.GpuVramFree)]
    [InlineData(HardwareType.GpuIntel, SensorType.Load, "GPU Media", SensorRole.GpuLoadVideo)]
    [InlineData(HardwareType.Cpu, SensorType.Clock, "Cores (Average)", SensorRole.CpuCoreClockAverage)]
    [InlineData(HardwareType.Cpu, SensorType.Temperature, "Core (Tdie)", SensorRole.CpuTctlTdie)]
    [InlineData(HardwareType.Cpu, SensorType.Temperature, "Core (Tctl)", SensorRole.CpuTctlTdie)]
    [InlineData(HardwareType.Cpu, SensorType.Clock, "Core #3", SensorRole.CpuCoreClock)]
    [InlineData(HardwareType.SuperIO, SensorType.Voltage, "Vcore SoC", SensorRole.BoardVoltage)]
    [InlineData(HardwareType.SuperIO, SensorType.Voltage, "+5V", SensorRole.BoardVoltage)]
    [InlineData(HardwareType.SuperIO, SensorType.Voltage, "+3.3V", SensorRole.BoardVoltage)]
    [InlineData(HardwareType.SuperIO, SensorType.Voltage, "+3V Standby", SensorRole.BoardVoltage)]
    [InlineData(HardwareType.SuperIO, SensorType.Voltage, "AVCC", SensorRole.BoardVoltage)]
    [InlineData(HardwareType.SuperIO, SensorType.Voltage, "3VCC", SensorRole.BoardVoltage)]
    [InlineData(HardwareType.SuperIO, SensorType.Voltage, "VBat", SensorRole.BoardVoltage)]
    [InlineData(HardwareType.SuperIO, SensorType.Voltage, "DIMM", SensorRole.BoardVoltage)]
    [InlineData(HardwareType.SuperIO, SensorType.Voltage, "CPU Termination", SensorRole.BoardVoltage)]
    [InlineData(HardwareType.SuperIO, SensorType.Voltage, "CPU System Agent", SensorRole.BoardVoltage)]
    [InlineData(HardwareType.SuperIO, SensorType.Voltage, "VTT", SensorRole.BoardVoltage)]
    [InlineData(HardwareType.SuperIO, SensorType.Voltage, "VRM", SensorRole.BoardVoltage)]
    [InlineData(HardwareType.SuperIO, SensorType.Voltage, "CPU Core", SensorRole.BoardVoltage)]
    [InlineData(HardwareType.Storage, SensorType.Throughput, "Write Rate", SensorRole.StorageWriteRate)]

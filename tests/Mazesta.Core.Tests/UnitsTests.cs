...
public class UnitsTests
{
    ...
    [Fact] public void Clocks_from_one_gigahertz_are_shown_in_ghz_with_the_unit_attached() { Assert.Equal("4.33 GHz", Units.FormatWithSymbol(4325, Unit.MegaHertz)); Assert.Equal("3.60 GHz", Units.FormatWithSymbol(3600, Unit.MegaHertz)); Assert.Equal("797 MHz", Units.FormatWithSymbol(797, Unit.MegaHertz)); }
}

using Mazesta.Core.Hardware; using Mazesta.Desktop.ViewModels; using Mazesta.Hardware; using Mazesta.Monitoring; using Mazesta.Monitoring.Tests.Fakes; using Mazesta.Persistence; using Microsoft.Extensions.Logging.Abstractions; using Xunit;
